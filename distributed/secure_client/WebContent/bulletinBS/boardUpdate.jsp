	...
	<tr>
		<td>
			<table width="100%" cellpadding="0" cellspacing="0" border="0">
				...
				<td id = "title"><input name='titleInput' size='50' maxlength='100' width='8' height='30' id='titleInput'></td>
			...
			<table width="1500">
		     ...
		     <tr height="1" bgcolor="#dddddd"><td colspan="8" width="407"></td></tr>
		     	...
		     	<textarea name='bodyInput' cols='50' rows='20' id='content'></textarea>
		     	</td>
		     </tr>
		<tr height="1" bgcolor="#dddddd"><td colspan="8" width="407"></td></tr>
